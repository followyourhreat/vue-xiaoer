...
<template>
  <div class="stock">
    ...
    <dt-table ref="table" url="log/stock" :params="params" :columns="columns"></dt-table>
...
export default {
  data() {
    return {
      ...
      columns: [
        ...
        { title: "原库存", key: "old_stock" },
        { title: "更新后库存", key: "new_stock" },
        { title: "变更原因", key: "reason" },
        {
          title: "修改时间",
          key: " ctime",
          render: (h, params) => {
  ...
  methods: {
    ...
    getStockList() {
      this.$post("log/stock", { page: 0 }).then(res => {
